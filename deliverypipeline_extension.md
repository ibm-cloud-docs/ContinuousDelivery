...
keywords: static code scans, Delivery Pipeline, IBM Static Analyzer
...
2. In the processing stage, add a build job to run the code scan.
  ...
  e. Select or clear the **Set up service and space for me** check box as needed.
    ...
    * If you configured the service and bound app in your {{site.data.keyword.Bluemix_short}} space already, or if you want to configure these requirements manually, leave the check box cleared.
