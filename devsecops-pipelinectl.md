...
For more information about where this tool is used, see [Setting up your pipeline scripts](/docs/ContinuousDelivery?topic=ContinuousDelivery-cd-devsecops-setup-pipeline-scripts).
