...
Before you configure a {{site.data.keyword.secrets-manager_short}} tool integration, make sure that you have [provisioned an instance of the {{site.data.keyword.secrets-manager_short}} service](/docs/secrets-manager?topic=secrets-manager-create-instance#create-instance-ui).
{: important}
