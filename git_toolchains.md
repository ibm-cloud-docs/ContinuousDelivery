 ...
 * The provider for your source repository, such as GitHub or GitLab. If you want to use a different source provider, select it from the list of available repos.
   ...
   Resource groups are available in the Dallas, Washington, London, Frankfurt, and Tokyo regions. Cloud Foundry orgs are supported in the Dallas, London, and Frankfurt regions. Because Cloud Foundry orgs are deprecated, it is recommended that you use resource groups instead.
   {: important}
