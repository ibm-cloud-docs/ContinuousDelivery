...
현재는 도구 체인을 모든 지역에서 사용할 수 없지만, 모든 지역에 앱을 배치하도록 도구 체인을 구성할 수 있습니다. 더 자세히 알아보려면 [여러 지역에서 보안 웹 애플리케이션 배치](/docs/tutorials?topic=solution-tutorials-multi-region-webapp) 튜토리얼을 활용하십시오.
{: tip}
