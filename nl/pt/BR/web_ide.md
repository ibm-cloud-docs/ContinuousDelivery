...
Muitos dos comandos no {{site.data.keyword.webide}} também são acessíveis por meio de atalhos de teclado.
...
<tr><td> <img src="./images/debug_icon.png"  alt="O ícone de depuração"></td><td>Com o modo de Edição em tempo real, acesse o depurador
</td></tr>
</table>
