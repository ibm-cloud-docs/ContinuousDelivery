...
開始する前に、[サービスのご利用条件を確認します![外部リンク・アイコン](../../icons/launch-glyph.svg)](http://www.ibm.com/software/sla/sladb.nsf/sla/bm-6814-01){: new_window}。
...
詳しくは、[Slack の Incoming WebHook 資料![外部リンク・アイコン](../../icons/launch-glyph.svg)](https://api.slack.com/incoming-webhooks){: new_window}を参照してください。
