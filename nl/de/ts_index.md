...
Anhand einer der folgenden Optionen gelangen Sie zur Statusseite:
  ...
  * Greifen Sie direkt über [{{site.data.keyword.Bluemix_notm}} - Systemstatus](https://cloud.ibm.com/status){: external} darauf zu.

Weitere Informationen zur {{site.data.keyword.Bluemix_notm}}-Statusseite finden Sie in [{{site.data.keyword.Bluemix_notm}}-Status anzeigen](/docs/get-support?topic=get-support-viewing-cloud-status#viewing-cloud-status).
