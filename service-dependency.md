...
| IBM Cloud Global Search and Tagging | Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
| IBM Cloud Global Search and Tagging | Instance control, Security compliance | No | Both |  [Global](/docs/resiliency?topic=resiliency-ha-redundancy#global-platform)  |
...
| IBM Cloud Direct Link Services | Instance control | No | Both |  Same region  |
...
| IBM Cloud Event Notifications | Instance control | Yes | Both |  Same region  |
| IBM Cloud Service Endpoints | Availability, Change management, Disaster recovery, Instance control | No | Both |  Same region  |
...
| IBM Cloud Logs| Access management, Operations, Security compliance | No | Both |  Same region  |
